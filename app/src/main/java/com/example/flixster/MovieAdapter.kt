...
class MovieAdapter(private val context: Context, private val movies:List<Movie>, private val orient: String) :
    ...
    fun bind(movie: Movie) {
        tvTitle.text = movie.overview
        tvOverview.text = movie.title
        if(orient == "port") {
